...
function mean_acc = cross_validate_svm(tr_images, tr_labels, nfold, tr_identity)
...
for i=1:nfold
  ...
  allPts_norm = allPts - mean(allPts(:));
  allPts_norm = allPts_norm/std(allPts(:));
  allPts = allPts_norm;
